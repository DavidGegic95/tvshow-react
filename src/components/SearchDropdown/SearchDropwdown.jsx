        ...
        searchResults?.map((singleMovie, index) => {
          ...
          return (
            <div
              ...
              onClick={() => onClickButton(singleMovie?.show)}
              key={index}
            >
              {singleMovie?.show?.image?.medium ? (
                <img
                  className="searchReultsImage"
                  src={singleMovie?.show?.image?.medium}
                  alt="movie"
                />
              ) : (
      ...
      {searchOption === "Single" && searchResults !== null && (
        <div className="searchResult">
          {searchResults?.image?.medium ? (
            <img
              className="searchReultsImage"
              src={searchResults?.image?.medium}
              alt="movie"
            />
          ) : (
